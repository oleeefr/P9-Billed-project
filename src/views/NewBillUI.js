          ...
          <form data-testid="form-new-bill">
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half formData" data-error="Extension du fichier non valide (uniquement .jpg, .jpeg ou png)">
                    <label for="file" class="bold-label">Justificatif</label>
                    <input required type="file" class="form-control blue-border text-file" data-testid="file" />
                  </div>
                </div>
            </div>
            <div class="row">
